...
millde_index = total_number//2
train_features = features[:millde_index,:]
train_labels = labels[:millde_index]
test_features = features[millde_index:,:]
test_labels = labels[millde_index:]
