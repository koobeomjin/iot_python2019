# 총 조합 갯수 = 2047
# 5% MAX 조합: lotsize bathrms fullbase01 garagepl prefarea01 >> 26.36 %
# 10% MAX 조합: lotsize bathrms stories driveway01
# recroom01 airco01 prefarea01 >> 45.74 %
# 20% MAX 조합: lotsize bathrms stories driveway01
# fullbase01 gashw01 airco01 prefarea01 >> 72.09 %
# 프로그램 소요 시간:  0:00:07.193000
...
columns_change = ['longitude01','latitude01','housing_median_age01',
                  'total_rooms01','total_bedrooms01','population01',
                  'households01','median_income01','median_house_value01']
columns_ori = ['longitude','latitude','housing_median_age',
...
label = house['ocean_proximity']
independent_variables_list = ['longitude', 'latitude','housing_median_age','total_rooms','total_bedrooms',
...
# print(match_dic_10)
# print(match_dic_20)
print('총 조합 갯수 = %d'%(len(match_dic_10)))
