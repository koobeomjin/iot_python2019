...
# 목표 정답률: 선형 통계모델에서의 독립변수를 모두 조합한 결과 약 53.0244%를
#             초과한 정답률
#  독립변수 최적화 분석 결과
# 총 조합 갯수: 562
# MAX 조합: fixed acidity volatile acidity citric acid residual sugar free sulfur dioxide sulphates alcohol >> 52.27 %
